...
class ArticleSentiment:
    ...
    def __init__(self, start_date, end_date):
        ...
        #db.create_january_description()
        #db.create_january_sentiments()

        #db.create_feb_description()
        #db.create_feb_sentiments()

        #db.create_march_description()
        #db.create_march_sentiments()

        #db.create_april_description()
        #db.create_april_sentiments()

        #db.create_may_description()
        #db.create_may_sentiments()

        #db.create_june_description()
        #db.create_june_sentiments()

        #db.create_july_description()
        #db.create_july_sentiments()
